    ...
    useEffect(() => {
        ...
        mm.add(
            ...
            (context) => {
                ...
                /* ===== PACK 1 (OUTWARD) ===== */
                // For Mobile 
                tl.to(".pack1-left", { x: -window.innerWidth * moveX, duration: 2, }, 1);
                tl.to(".pack1-top", { y: -window.innerHeight * moveY, duration: 2, }, 1);
                tl.to(".pack1-right", { x: window.innerWidth * moveX, duration: 2, }, 1);
                tl.to(".pack1-bottom", { y: window.innerHeight * moveY, duration: 2, }, 1);
