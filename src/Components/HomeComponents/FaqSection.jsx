  ...
  return (
    <div className="self-stretch relative bg-black overflow-hidden py-16">
      ...
      <div className="hidden lg:flex max-w-[1280px] mx-auto px-8 gap-12 items-center">
        ...
        <div className="relative w-[568px] h-[518px] rounded-[20px] overflow-hidden flex-shrink-0">
          <img
            src={nam}
            alt="FAQ Illustration"
            className="w-full h-full object-cover rounded-[20px]"
          />
          <div className="w-96 h-36 left-[24px] bottom-[24px] absolute bg-slate-50 rounded-2xl" />
          <div className="w-80 left-[48px] bottom-[40px] absolute text-zinc-800 text-3xl font-medium font-['Nunito'] leading-10">
        ...
        <div className="flex-1 flex flex-col gap-6">
          {/* Heading */}
          <h2 className="text-white text-4xl font-semibold font-['Nunito'] leading-[57px]">
          ...
          <div className="flex flex-col gap-4 mt-4">
            {faqs.map((item, i) => (
              <div
                ...
                className="bg-white/10 rounded-[20px] outline outline-1 outline-zinc-400 cursor-pointer transition-all duration-300"
              >
                <div className="flex items-center justify-between px-6 py-4 relative">
                  ...
                  {/* Question */}
                  <span className="ml-14 text-white text-2xl font-normal font-['Work_Sans']">
                    {item.q}
                  </span>
                  {/* Arrow */}
                  <FiChevronDown
