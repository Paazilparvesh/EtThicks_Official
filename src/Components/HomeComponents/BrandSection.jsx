...
function BrandSection() {
  return (
    <div
      className="w-full relative h-screen  lg:-mb-80 xl:-mb-52  2xl:-mb-52 bg-black"
      style={{
    ...
    >
      ...
      <div className="hidden lg:block w-[calc(100vw-150px)] mx-auto h-[calc(100vh-30vh)] relative">
        ...
        <div className="w-[calc(100vw-150px)] mx-auto lg:h-[calc(120vh-59vh)] xl:h-[calc(100vh-25vh)] 2xl:h-[calc(10q0vh-8vh)] bg-white/10 rounded-[77px] border border-white/10 backdrop-blur-xs  absolute" />
        {/* TOP */}
        ...
        <div className="w-full absolute top-60 lg:top-70 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center pointer-events-none xl:pt-12">
          <h1 className="text-amber-500 text-6xl md:text-7xl xl:text-8xl  lg:text-6xl font-semibold text-center font-worksans">
            Brand Personality
          </h1>
          <p className="text-white text-xl lg:text-[20px] lg:pl-20   lg:pr-20  xl:pl-10   xl:pr-10 2xl:pl-20   2xl:pr-20   md:text-2xl mt-6 text-center max-w-3xl leading-relaxed font-nunito">
      ...
      <div className="lg:hidden flex flex-col pt-0 items-center justify-center gap-3 px-4 h-[80vh] ">
        ...
        <p className="text-gray-200 text-2xl sm:text-lg md:text-xl mx-10 text-center leading-relaxed">
          We aim to take brands in all eight directions expanding their reach
          while making them trusted, impactful, and unforgettable.
        </p>

        {/* Brands in Bento Grid */}
        <div className="absolute grid grid-cols-4 grid-rows-3 gap-4 mt-8 opacity-30 blur-sm px-10">
